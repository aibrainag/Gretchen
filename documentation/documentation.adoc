...
Bend the two pins of the thermistor (TO92 housing) by 90 degrees and solder to the bottom of the board, the thermistor body should be placed below the H-bridge with the flat side close to the surface.
